...
static rtwCAPI_BlockParameters rtBlockParameters[] =
{
   ...
   */
  {
    2, TARGET_STRING("ControllerRef/NormalGain"),
  ...
  rtB_ControllerRef_T *localB, InstP_ControllerRef_T *ControllerRef_InstP_arg)
{
  ...
  dataAddr[2] = (void*) (&ControllerRef_P.NormalGain_Gain);
  dataAddr[3] = (void*) (&ControllerRef_InstP_arg->SubmodelConfig);
}
  ...
  ControllerRef_M, rtB_ControllerRef_T *localB)
{
  ...
  rtwCAPI_SetChildMMIArray(ControllerRef_M->DataMapInfo.mmi, (NULL));
  rtwCAPI_SetChildMMIArrayLen(ControllerRef_M->DataMapInfo.mmi, 0);
}
